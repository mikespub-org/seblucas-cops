...
class FilterTest extends TestCase
{
    ...
    public function testGetEntryArray(): void
    {
        ...
        $this->assertEquals(Route::url(self::$endpoint) . "?page=3&id=1", $entries[0]->getNavLink(self::$endpoint));
        ...
        $this->assertEquals(Route::url(self::$endpoint) . "?page=18&id=1", $entries[0]->getNavLink(self::$endpoint));
        ...
        $this->assertEquals(Route::url(self::$endpoint) . "?page=21&id=2", $entries[0]->getNavLink(self::$endpoint));
        ...
        $this->assertEquals(Route::url(self::$endpoint) . "?page=23&id=1", $entries[0]->getNavLink(self::$endpoint));
        ...
        $this->assertEquals(Route::url(self::$endpoint) . "?page=7&id=1", $entries[0]->getNavLink(self::$endpoint));
        ...
        $this->assertEquals("2 books", $entries[0]->content);
        $this->assertEquals(Route::url(self::$endpoint) . "?page=15&custom=1&id=1", $entries[0]->getNavLink(self::$endpoint));
        ...
        $this->assertEquals(Route::url(self::$endpoint) . "?page=5&id=C", $entries[0]->getNavLink(self::$endpoint));
