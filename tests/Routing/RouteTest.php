...
class RouteTest extends TestCase
{
    ...
    public static function routeProvider()
    {
        ...
        return [
            ...
            ["/fetch/0/20/Alice_s_Adventures_in_Wonderland_Lewis_Carroll.kepub.epub", "fetch-data", ["_handler" => "fetch", "db" => "0", "data" => "20", "ignore" => "Alice's Adventures in Wonderland - Lewis Carroll", "type" => "kepub.epub"]],
