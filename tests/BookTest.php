...
class BookTest extends TestCase
{
    ...
    public function testBookGetLinkArrayWithUrlRewriting(): void
    {
        ...
        foreach ($linkArray as $link) {
            if ($link->rel == LinkEntry::OPDS_ACQUISITION_TYPE && $link->title == "EPUB") {
                $this->assertEquals(Route::path("download/1/The%20Return%20of%20Sherlock%20Holmes%20-%20Arthur%20Conan%20Doyle.epub"), $link->href);
                return;
            }
        }
        $this->fail();
    ...
    public function testGetDataById(): void
    {
        ...
        $epub = $book->getDataById(20);
        $this->assertEquals(Route::path("download/20/Carroll%2C%20Lewis%20-%20Alice%27s%20Adventures%20in%20Wonderland.kepub.epub"), $epub->getHtmlLink());
        $this->assertEquals(Route::path("download/17/Alice%27s%20Adventures%20in%20Wonderland%20-%20Lewis%20Carroll.mobi"), $mobi->getHtmlLink());
