...
class RouteTest extends TestCase
{
    ...
    public static function getLinks()
    {
        return [
            ...
            "index.php?page=9&query=alice" => "index.php/query/alice",
            "index.php?page=9&query=alice&scope=book" => "index.php/query/alice/book",
            "index.php?page=9&search=1&query=alice" => "index.php/search/alice",
            "index.php?page=9&search=1&query=alice&scope=book" => "index.php/search/alice/book",
