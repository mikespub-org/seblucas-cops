...
class PageHandler extends BaseHandler
{
    public static function getRoutes()
    {
        ...
        return [
            ...
            "/search/{query}/{scope}" => ["page" => PageId::OPENSEARCH_QUERY, "search" => 1],
            "/search/{query}" => ["page" => PageId::OPENSEARCH_QUERY, "search" => 1],
            "/query/{query}/{scope}" => PageId::OPENSEARCH_QUERY,
            "/query/{query}" => PageId::OPENSEARCH_QUERY,
