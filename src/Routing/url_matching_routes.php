...
return [
    ...
    [ // $staticRoutes
        ...
        '/customize' => [[['_route' => 'page-customize', 'page' => 'customize'], null, ['GET' => 0], null, false, false, null]],
    ...
    [ // $dynamicRoutes
        34 => [[['_route' => 'page-authors-letter', 'page' => 'authors_letter'], ['id'], ['GET' => 0], null, false, true, null]],
        ...
        96 => [[['_route' => 'page-books-letter', 'page' => 'books_letter'], ['id'], ['GET' => 0], null, false, true, null]],
        113 => [[['_route' => 'page-books-year', 'page' => 'books_year'], ['id'], ['GET' => 0], null, false, true, null]],
