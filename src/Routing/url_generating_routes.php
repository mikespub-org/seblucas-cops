...
return [
    ...
    'fetch-format' => [['path'], ['_handler' => 'SebLucas\\Cops\\Handlers\\FetchHandler', '_route' => 'fetch-format'], ['path' => '.+'], [['variable', '/', '.+', 'path'], ['text', '/format']], [], [], []],
    'fetch-image' => [['size', 'path'], ['image' => 1, '_handler' => 'SebLucas\\Cops\\Handlers\\FetchHandler', '_route' => 'fetch-image'], ['path' => '.+'], [['variable', '/', '.+', 'path'], ['variable', '/', '[^/]++', 'size'], ['text', '/images']], [], [], []],
    ...
    'read-format' => [['path'], ['_handler' => 'SebLucas\\Cops\\Handlers\\ReadHandler', '_route' => 'read-format'], ['path' => '.+'], [['variable', '/', '.+', 'path'], ['text', '/read']], [], [], []],
    ...
    'restapi-database-table' => [['db', 'name'], ['_resource' => 'Database', '_handler' => 'SebLucas\\Cops\\Handlers\\RestApiHandler', '_route' => 'restapi-database-table'], ['db' => '\\d+', 'name' => '\\w+'], [['variable', '/', '\\w+', 'name'], ['variable', '/', '\\d+', 'db'], ['text', '/restapi/databases']], [], [], []],
    'restapi-database' => [['db'], ['_resource' => 'Database', '_handler' => 'SebLucas\\Cops\\Handlers\\RestApiHandler', '_route' => 'restapi-database'], ['db' => '\\d+'], [['variable', '/', '\\d+', 'db'], ['text', '/restapi/databases']], [], [], []],
    ...
    'restapi-folders' => [['path'], ['_resource' => 'Folder', '_handler' => 'SebLucas\\Cops\\Handlers\\RestApiHandler', '_route' => 'restapi-folders'], ['path' => '.*'], [['variable', '/', '.*', 'path'], ['text', '/restapi/folders']], [], [], []],
    ...
    'zipfs-format' => [['path'], ['_handler' => 'SebLucas\\Cops\\Handlers\\ZipFsHandler', '_route' => 'zipfs-format'], ['path' => '.+'], [['variable', '/', '.+', 'path'], ['text', '/zipfs']], [], [], []],
    ...
    'tables-db-name' => [['db', 'name'], ['_handler' => 'SebLucas\\Cops\\Handlers\\TableHandler', '_route' => 'tables-db-name'], ['db' => '\\d+', 'name' => '\\w+'], [['variable', '/', '\\w+', 'name'], ['variable', '/', '\\d+', 'db'], ['text', '/tables']], [], [], []],
    'tables-db' => [['db'], ['_handler' => 'SebLucas\\Cops\\Handlers\\TableHandler', '_route' => 'tables-db'], ['db' => '\\d+'], [['variable', '/', '\\d+', 'db'], ['text', '/tables']], [], [], []],
