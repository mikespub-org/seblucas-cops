...
return [
    ...
    [ // $staticRoutes
        ...
        '/restapi/custom' => [[['_route' => 'restapi-custom', '_resource' => 'CustomColumnType', '_handler' => 'restapi'], null, null, null, false, false, null]],
        '/restapi/databases' => [[['_route' => 'restapi-databases', '_resource' => 'Database', '_handler' => 'restapi'], null, null, null, false, false, null]],
        '/restapi/openapi' => [[['_route' => 'restapi-openapi', '_resource' => 'openapi', '_handler' => 'restapi'], null, null, null, false, false, null]],
        '/restapi/routes' => [[['_route' => 'restapi-routes', '_resource' => 'route', '_handler' => 'restapi'], null, null, null, false, false, null]],
        '/restapi/handlers' => [[['_route' => 'restapi-handlers', '_resource' => 'handler', '_handler' => 'restapi'], null, null, null, false, false, null]],
        '/restapi/notes' => [[['_route' => 'restapi-notes', '_resource' => 'Note', '_handler' => 'restapi'], null, null, null, false, false, null]],
        '/restapi/preferences' => [[['_route' => 'restapi-preferences', '_resource' => 'Preference', '_handler' => 'restapi'], null, null, null, false, false, null]],
        '/restapi/annotations' => [[['_route' => 'restapi-annotations', '_resource' => 'Annotation', '_handler' => 'restapi'], null, null, null, false, false, null]],
        '/restapi/user/details' => [[['_route' => 'restapi-user-details', '_resource' => 'User', '_handler' => 'restapi'], null, null, null, false, false, null]],
        '/restapi/user' => [[['_route' => 'restapi-user', '_resource' => 'User', '_handler' => 'restapi'], null, null, null, false, false, null]],
    ...
    [ // $dynamicRoutes
        ...
        886 => [[['_route' => 'restapi-databases-db-name', '_resource' => 'Database', '_handler' => 'restapi'], ['db', 'name'], null, null, false, true, null]],
        894 => [[['_route' => 'restapi-databases-db', '_resource' => 'Database', '_handler' => 'restapi'], ['db'], null, null, false, true, null]],
        941 => [[['_route' => 'restapi-notes-type-id-title', '_resource' => 'Note', '_handler' => 'restapi'], ['type', 'id', 'title'], null, null, false, true, null]],
        949 => [[['_route' => 'restapi-notes-type-id', '_resource' => 'Note', '_handler' => 'restapi'], ['type', 'id'], null, null, false, true, null]],
        958 => [[['_route' => 'restapi-notes-type', '_resource' => 'Note', '_handler' => 'restapi'], ['type'], null, null, false, true, null]],
        987 => [[['_route' => 'restapi-preferences-key', '_resource' => 'Preference', '_handler' => 'restapi'], ['key'], null, null, false, true, null]],
        1027 => [[['_route' => 'restapi-annotations-bookId-id', '_resource' => 'Annotation', '_handler' => 'restapi'], ['bookId', 'id'], null, null, false, true, null]],
        1036 => [[['_route' => 'restapi-annotations-bookId', '_resource' => 'Annotation', '_handler' => 'restapi'], ['bookId'], null, null, false, true, null]],
        1087 => [[['_route' => 'restapi-metadata-bookId-element-name', '_resource' => 'Metadata', '_handler' => 'restapi'], ['bookId', 'element', 'name'], null, null, false, true, null]],
        1096 => [[['_route' => 'restapi-metadata-bookId-element', '_resource' => 'Metadata', '_handler' => 'restapi'], ['bookId', 'element'], null, null, false, true, null]],
        1106 => [[['_route' => 'restapi-metadata-bookId', '_resource' => 'Metadata', '_handler' => 'restapi'], ['bookId'], null, null, false, true, null]],
        ...
        1227 => [[['_route' => 'inline-db-data-ignore.type', 'view' => 1, '_handler' => 'fetch'], ['db', 'data', 'ignore', 'type'], null, null, false, true, null]],
        ...
        1412 => [[['_route' => 'view-data-db-ignore.type', 'view' => 1, '_handler' => 'fetch'], ['data', 'db', 'ignore', 'type'], null, null, false, true, null]],
        1441 => [[['_route' => 'view-data-ignore.type', 'view' => 1, '_handler' => 'fetch'], ['data', 'ignore', 'type'], null, null, false, true, null]],
