...
class PageAllCustoms extends Page
{
    ...
    public function initializeContent()
    {
        ...
        $columnType = CustomColumnType::createByCustomID($customId, $this->getDbContext(), false);
    ...
    public function getCustomEntries($columnType)
    {
        ...
        if ($this->config('custom_date_split_year') == 1 && $columnType instanceof CustomColumnTypeDate) {
            ...
            $this->entryArray = $columnType->browseAllCustomValues($this->n, $this->sorted, $this->request->get('tree'));
